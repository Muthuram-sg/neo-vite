...
function Tabing(props){
    ...
    return (  
            <TabContent width="250px" id={props.index} value={t(props.title)} selected={props.isSelected} icon={props.selectedIcon} onClick={(event) => props.tabChange(event, props.index)}   />
    )
} 
