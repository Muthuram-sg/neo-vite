...
// import useNewpolicy from "./hooks/useAddSensor";
...
// const Newpolicy = React.forwardRef((props, ref) => {
...
//   const [bredCrumbName, setbredCrumbName] = useState("New Policy");
...
//   ];
//   const { NewpolicyLoading, NewpolicyData, NewpolicyError, getNewpolicy } =
//     useNewpolicy();
...
//   let dialogTitle;
//   let subdialoTitle = "Policy Description";
...
// //   useEffect(() => {
// //     if (!NewpolicyLoading && NewpolicyData && !NewpolicyError) {
...
// //       setOpenSnack(true);
// //     }
// //   }, [NewpolicyLoading, NewpolicyData, NewpolicyError]);
...
//                 mandatory
//               />
//               <TypographyNDL value="Effective Date *" variant="paragraph-xs" />
//               <NewDatepicker
//                 id="custom-range-3"
//                 onChange={(dates) => {
...
//                 mandatory
//               />
//               <TypographyNDL value="Expiry Date *" variant="paragraph-xs" />
//               <NewDatepicker
//                 id="custom-range-3"
//                 onChange={(dates) => {
//                   const [start, end] = dates;
...
//             variant="lable-01-s"
//             color="secondary"
//             value={"Provide a brief summary of the policy"}
//           />
//         </div>
//         <Grid container style={{ padding: "1px", "padding-left": "0px" }}>
//           <Grid item xs={12}>
...
//             color="secondary"
//             value={
//               "Do you want to apply the changes to all axis under this instrument."
//             }
//             variant="lable-01-s"
//           />
//         </ModalContentNDL>
