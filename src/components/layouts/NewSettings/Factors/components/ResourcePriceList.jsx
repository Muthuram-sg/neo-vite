...
import useGetInstrumentFarmula from 'components/layouts/Settings/factors/VirutalInstrument/hooks/useGetInstrumentFarmula.jsx'
        ...
        if (
            ...
            setTimeout(() => {
              ...
              if (headPlant.node && headPlant.node.nodes?.length > 0) {
                ...
                let waterunit = headPlant.node.nodes.filter(e => e.type === 2 && e.checked === true);
                let LPGunit = headPlant.node.nodes.filter(e => e.type === 3 && e.checked === true);
                let CNGunit = headPlant.node.nodes.filter(e => e.type === 4 && e.checked === true);
                ...
                if (energyunit.length > 0) {
                  console.log(energyunit[0].radio, "energyunit[0].radio");
                  if (energyunit[0].radio && energyunit[0].radio === 'hierarchy') {
                    temptabledata.push([
                      ...
                      "-", 
                      "-", 
                      renderHierarchyName(energyunit[0].selectedHierarchy) || '-'
                    ]);
                  } else {
                    assetData = outDTData.find(e => e.id === energyunit[0].asset) || {};
                    nodeString = energyunit[0].nodes?.length > 1 ? ` +${energyunit[0].nodes.length - 1} more` : "";
                    temptabledata.push([
                      'Electricity Unit Price', 
                      energyunit[0].price || '-', 
                      assetData.name || '-', 
                      (energyunit[0].nodes?.[0]?.name || '-') + nodeString,
                      "-"
                    ]);
                  }
                }
                ...
                if (waterunit.length > 0) {
                  if (waterunit[0].radio && waterunit[0].radio === 'hierarchy') {
                    temptabledata.push([
                      ...
                      "-", 
                      "-", 
                      renderHierarchyName(waterunit[0].selectedHierarchy) || '-'
                    ]);
                  } else {
                    assetData = outDTData.find(e => e.id === waterunit[0].asset) || {};
                    nodeString = waterunit[0].nodes?.length > 1 ? ` +${waterunit[0].nodes.length - 1} more` : "";
                    temptabledata.push([
                      'Water Price', 
                      waterunit[0].price || '-', 
                      assetData.name || '-', 
                      (waterunit[0].nodes?.[0]?.name || '-') + nodeString,
                      "-"
                    ]);
                  }
                }
                ...
                if (LPGunit.length > 0) {
                  if (LPGunit[0].radio && LPGunit[0].radio === 'hierarchy') {
                    temptabledata.push([
                      ...
                      "-", 
                      "-", 
                      renderHierarchyName(LPGunit[0].selectedHierarchy) || '-'
                    ]);
                  } else {
                    assetData = outDTData.find(e => e.id === LPGunit[0].asset) || {};
                    nodeString = LPGunit[0].nodes?.length > 1 ? ` +${LPGunit[0].nodes.length - 1} more` : "";
                    temptabledata.push([
                      'LPG Gas Price', 
                      LPGunit[0].price || '-', 
                      assetData.name || '-', 
                      (LPGunit[0].nodes?.[0]?.name || '-') + nodeString,
                      "-"
                    ]);
                  }
                }
                ...
                if (CNGunit.length > 0) {
                  if (CNGunit[0].radio && CNGunit[0].radio === 'hierarchy') {
                    temptabledata.push([
                      ...
                      "-", 
                      "-", 
                      renderHierarchyName(CNGunit[0].selectedHierarchy) || '-'
                    ]);
                  } else {
                    assetData = outDTData.find(e => e.id === CNGunit[0].asset) || {};
                    nodeString = CNGunit[0].nodes?.length > 1 ? ` +${CNGunit[0].nodes.length - 1} more` : "";
                    temptabledata.push([
                      'CNG Gas Price', 
                      CNGunit[0].price || '-', 
                      assetData.name || '-', 
                      (CNGunit[0].nodes?.[0]?.name || '-') + nodeString,
                      "-"
                    ]);
                  }
                }
      ...
      const headCells = [
        ...
        return (
            <div className="bg-Background-bg-secondary dark:bg-Background-bg-secondary-dark">
              {outDTLoading && <LoadingScreenNDL />}
              <Grid container spacing={2}>
                <Grid item xs={6} sm={6} style={{padding: "0px 0px 16px 0px"}}>
