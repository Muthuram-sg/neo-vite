...
function HierarchySetting(){
  const { t } = useTranslation();
   ...
   useEffect(()=>{
    ...
    const breadcrump = [{ id: 0, name: 'Hierarchy' }, { id: 1, name: 'Edit Hierarchy' }]
    ...
    return(
        <React.Fragment>  
                   ...
                   <div className='flex items-center justify-between bg-Background-bg-primary dark:bg-Background-bg-primary-dark h-[48px] p-3'>
                   {
                        isEdit ? 
                        <React.Fragment>
                        ...
                        :
                        <React.Fragment>
  <TypographyNDL variant='heading-02-xs' value={t('Hierarchy')} />   
  <ButtonNDL  value={"Add Hierarchy"} type={'tertiary'}  icon={Plus} onClick={addHierarchy} />  
                ...
                <Grid container spacing={0}>
                    {/* HIERARCHY LIST */}
                        <Grid item xs={4} sm={4} style={{display:!isEdit ? "block" : 'none'}}>
