...
export default function MetricsGroup() {
    ...
    const [uneditableuser,setuneditableuser]= useState([7]); 
    ...
    const processedrows = () => {
        ...
        if (!GroupMetricLoading && GroupMetricData && !GroupMetricError) {
            ...
            temptabledata = temptabledata.concat(GroupMetric.map((val, index) => {
                const updatedByName = userMap[val.updated_by] || ''; 
                const createdByName = userMap[val.created_by] || ''; 

                if (val.created_by !== currUser.id) {
                    uneditableUserIndices.push(index);
                }
        ...
        setuneditableuser(uneditableUserIndices); 
    }
        ...
        <React.Fragment>
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                        ...
                        <div className="p-4 min-h-[92vh]  bg-Background-bg-secondary dark:bg-Background-bg-secondary-dark ">
                        <EnhancedTable
                            headCells={headCells}
                            data={tabledata}
