...
const AddShiftCalendar = React.forwardRef((props, ref) => {
  ...
  const [, setShiftDialog] = useState(false);//NOSONAR
  ...
  const [, setSeries] = useState([])//NOSONAR
  ...
  useEffect(() => {
    if(props.shiftData)//NOSONAR
      callseries()
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [props.shiftData])//NOSONAR
...
// eslint-disable-next-line react-hooks/exhaustive-deps
          for (let i = 0; i < Object.keys(shitdatas.shift.shifts).length; i++) {//NOSONAR
...
// eslint-disable-next-line react-hooks/exhaustive-deps
          for (let j = 0; j < Object.keys(dayslistval[0]).length; j++) {//NOSONAR
            for (let i = 0; i < shitdatas.shift.shifts.length; i++) {//NOSONAR
...
// eslint-disable-next-line react-hooks/exhaustive-deps
            for (let i = 0; i < dailydata.shifts[j].length; i++) {//NOSONAR
              let labels = Object.keys(dailydata.shifts)[j]
              let s1;
              let s2;
              let e1;
              ...
              obj = {
                ...
                "data": [{
                  "x": labels === "0" ? "Sunday" : labels === "1" ? "Monday" : labels === "2" ? "Tuesday" : labels === "3" ? "Wednesday" : labels === "4" ? "Thurday" : labels === "5" ? "Friday" : labels === "6" ? "Saturday" : "0", "y": [new Date(moment().format(`YYYY-MM-DDT` + s1 + ":" + s2 + `Z`)).getTime(),//NOSONAR
                  new Date(moment().format(`YYYY-MM-DDT` + e1 + ":" + e2 + `Z`)).getTime()]
                }]
              }
              array.push(obj);
  ...
  const handletimetoChange = (e, field) => {//NOSONAR
    let timeto = [...selectedtimeend];
    let timestart = [...selectedtimestart];
    let val = new Date(e).toISOString().split('T');
  ...
  const handlesundaytimetoChange = (e, field) => {//NOSONAR
    if (Object.prototype.toString.call(e) === "[object Date]") {
      if (!isNaN(e.getTime())) {
        let timeto = [...sundaytimend];
        let timestart = [...sundaytimestart];
  ...
  // NOSONAR - This function requires Arrow function
  const handletimetoChangeMon = (e, field) => {//NOSONAR
    if (Object.prototype.toString.call(e) === "[object Date]") {
      if (!isNaN(e.getTime())) {
        let timeto = [...montimend];
        let timestart = [...montimestart];
  ...
  // NOSONAR - This function requires Arrow function
  const handletimetoChangeTue = (e, field) => {//NOSONAR
    if (Object.prototype.toString.call(e) === "[object Date]") {
      if (!isNaN(e.getTime())) {
        let timeto = [...tuetimend];
        let timestart = [...tuetimestart];
  ...
  // NOSONAR - This function requires Arrow function
  const handletimetoChangewed = (e, field) => {//NOSONAR
    if (Object.prototype.toString.call(e) === "[object Date]") {
      if (!isNaN(e.getTime())) {
        let timeto = [...wedtimend];
        let timestart = [...wedtimestart];
  ...
  // NOSONAR - This function requires Arrow function
  const handletimetoChangethu = (e, field) => {//NOSONAR
    if (Object.prototype.toString.call(e) === "[object Date]") {
      if (!isNaN(e.getTime())) {
        let timeto = [...thutimend];
        let timestart = [...thutimestart];
  ...
  // NOSONAR - This function requires Arrow function
  const handletimetoChangefri = (e, field) => {//NOSONAR
    if (Object.prototype.toString.call(e) === "[object Date]") {
      if (!isNaN(e.getTime())) {
        let timeto = [...fritimend];
        let timestart = [...fritimestart];
  ...
  // NOSONAR - This function requires Arrow function
  const handletimetoChangesat = (e, field) => {//NOSONAR
    if (Object.prototype.toString.call(e) === "[object Date]") {
      if (!isNaN(e.getTime())) {
        let timeto = [...sattimend];
        let timestart = [...sattimestart];
  ...
  const addcalendervalue = () => {//NOSONAR
    if (isReading === true) {
      ...
      for (let key in finalobjs[2]) {
        ...
        // NOSONAR - This condition requires 
       
       console.log(startDate,key,endDate,"endDate")
        obj[key] = {
          name: (name) ? name[key] === undefined || name[key] === '' ? "" : name[key] : "",//NOSONAR
          startDate: (startDate) ? (startDate[key] !== null && startDate[key] ? startDate[key].getUTCHours === undefined ? utchours(startDate[key]) : addzeros(startDate[key].getUTCHours(), 'hr') + ":" + startDate[key].getMinutes === undefined ? null : addzeros(startDate[key].getUTCHours(), 'hr') + ":" + addzeros(startDate[key].getUTCMinutes()) : null) : null,//NOSONAR
          endDate: (endDate) ?( endDate[key] !== null && endDate[key]) ? endDate[key].getUTCHours === undefined ? utchours(endDate[key]) : addzeros(endDate[key].getUTCHours(), 'hr') + ":" + endDate[key].getMinutes === undefined ? null : addzeros(endDate[key].getUTCHours(), 'hr') + ":" + addzeros(endDate[key].getUTCMinutes()) : null : null,//NOSONAR
          isDST: moment(new Date()).isDST()
        }

        datarrays.push(obj[key])
      }
      // NOSONAR - This loop requires
      ...
      for (let i = 0; i < addFields.length; i++) {
        if (datarrays[i] !== undefined) {
          console.log(datarrays[i].startDate,"datarrays[i].startDate")
          if (datarrays[i].startDate !== "" && datarrays[i].startDate !== null && datarrays[i].endDate !== "" && datarrays[i].endDate !== null) {
            ...
            setSnackMessage('Name or Starting Or Ending Period cannot be empty')
            setSnackType("warning")
            setOpenSnack(true)
            return false
          }
      ...
      if(hasNaN){
        ...
        props.getupdateshiftwithoutID({ line_id: props.headPlant.id, shift: datas })//NOSONAR
      }
      ...
      for (let key in sunobj[2]) {
        ...
        obj1[key] = {
          name: (name) ? name[key] === undefined || name[key] === '' ? "-" : name[key] : "-",//NOSONAR
          startDate: (startDate) ? startDate[key] !== null ? utchours(startDate[key]) : null : null,//NOSONAR
          endDate: (endDate) ? (endDate[key] !== null ? utchours(endDate[key]) : null) : null,//NOSONAR
          isDST: moment(new Date()).isDST()
        }
...
// NOSONAR - This below requires condition
        obj2[key] = {
          name: (name) ? name[key] === undefined || name[key] === '' ? "-" : name[key] : "-",//NOSONAR
          startDate: (startDate) ? (startDate[key] && startDate[key] !== null ? utchours(startDate[key]) : null) : null,//NOSONAR
          endDate: (endDate) ? (endDate[key] !== null ? utchours(endDate[key]) : null) : null,//NOSONAR
          isDST: moment(new Date()).isDST()
        }
...
// NOSONAR - This function requires Arrow function
  function hasNaNStartTime(arr) {
    return arr.some(obj => obj.startDate === 'NaN:NaN' || obj.startDate  === 'NaN:NaN' ||  obj.name.trim() === '' );//NOSONAR
}
    // NOSONAR start - Design issue 
