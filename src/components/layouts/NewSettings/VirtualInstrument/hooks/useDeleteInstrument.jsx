...
const useDeleteInstrument = () => {
    const [outDelInstrumentLoading, setLoading] = useState(false);//NOSONAR
    const [outDelInstrumentData, setData] = useState(null);//NOSONAR
    const [outDelInstrumentError, setError] = useState(null);//NOSONAR
