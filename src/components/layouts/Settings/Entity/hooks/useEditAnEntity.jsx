...
const useEditAnEntity = () => {
    ...
    const getEditAnEntity = async (entity_id,id,name,entity_type,asset_types,info,zone) => {
        setLoading(true);
        await configParam.RUN_GQL_API(Mutations.EditAnEntity,{ entity_id: entity_id,user_id: id, name: name, entity_type: entity_type, asset_types: asset_types,info:{fault_Analysis:info.isFaultAnalysis,contractInstrument:info.contractInstrument,target:info.target,tenure:info.tenure,ImageURL:info.ImageURL},is_zone:zone})
