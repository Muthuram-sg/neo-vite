...
const useUpdateDryerConfig = () => {
    ...
    return { UpdateDryerConfigLoading, UpdateDryerConfigData, UpdateDryerConfigError, getUpdateDryerConfig };
};

export default useUpdateDryerConfig;