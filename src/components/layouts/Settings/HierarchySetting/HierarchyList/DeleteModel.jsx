...
return(
    <ModalNDL onClose={handleDialogClose} maxWidth={"md"} aria-labelledby="entity-dialog-title" open={props.openDialog}>
        ...
        <ModalContentNDL>
            <TypographyNDL variant='paragraph-s' color='secondary' value={`Do you really want to delete the ${props.name} hierarchy ? This action cannot be undone`} variant="lable-01-s" />
        </ModalContentNDL>
        <ModalFooterNDL>
