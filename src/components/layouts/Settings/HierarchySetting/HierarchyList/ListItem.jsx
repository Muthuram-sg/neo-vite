...
function HierarchyList(props){
    ...
    const menuOptions = [
        ...
        {id:"edit",name:"Edit",stroke:"#000000",icon:Editpencil,toggle: false,RightIcon:false},
    ...
    return( 
        <li divider className=' hover:bg-Secondary_Interaction-secondary-hover mb-1 dark:hover:bg-Secondary_Interaction-secondary-hover cursor-pointer rounded-md' style={{ padding: 8, cursor: "pointer",display:'flex',alignItems: 'center', backgroundColor:(props.selectedHierarchy && props.selectedHierarchy.id === props.id) ? "#E0E0E0" : undefined }} selected={props.isSelected}>
            <div 
                id={'view-' + props.index} 
                style={{flex: '1 1 auto'}} 
