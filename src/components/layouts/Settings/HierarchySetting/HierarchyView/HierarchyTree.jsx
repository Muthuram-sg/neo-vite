    ...
    return (
        <SortableTree
            ...
            generateNodeProps={({ node, path, treeIndex }) => ({                
                title: (
                    <li id={'node-' + node.name} className="flex items-center " style={selectedNodeIndex===treeIndex?selectedListItemStyle:classes.ListItem} selected={props.selectedIndex ===treeIndex} button onClick={() => { props.handleNodeClick(node, path,treeIndex); setSelectedNodeIndex(treeIndex); }}>
