    ...
    <div>
      <React.Fragment>
        ...
        <ModalContentNDL>
          ...
          :
          <React.Fragment>
           <span className="block mb-2 text-[14px]  leading-[18px] font-medium text-Text-text-primary dark:text-Text-text-primary-dark my-2">Expiry Date</span>
  <DatePickerNDL
                                           id="Date-picker"
                                           onChange={(e) => {
        ...
        <ModalFooterNDL>
          <Button type="secondary" value={t('Cancel')}  onClick={() => handleDialogClosefn()} />
          {
            isConfirmationmsg ?
              ...
              :
              <Button type="primary" value={t('Save')}  onClick={() => handleConfirmDialog()} />
