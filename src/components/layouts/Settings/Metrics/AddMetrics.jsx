...
const AddMetrics = forwardRef((props,ref) =>{ 
    ...
    const addMetric = ()=>{
        ...
        var present = props.metricsListData.findIndex(val => val.name.toLowerCase() === nameRef.current.value.trim().toLowerCase())
        if (present >= 0 ){
 ...
 <TypographyNDL
  ...
  <div className="mt-3" />
                        ...
                        <div className="mt-4">
                        <Button id='reason-update' type={"ghost"} value={"Add Unit"} icon={AddLight} onClick={() => handleUnitDialog()}></Button>
                        </div>
                        </div>
  <div className="mt-3" />
  ...
  <div className="mt-3" />
            ...
            <ModalFooterNDL style={{ justifyContent: 'center' }}>
                ...
                <TypographyNDL variant="lable-01-s" color="secondary" value={t('Adding Channel')} />
                </div>
            </ModalFooterNDL>
            }
            {!AddMetricLoading &&
            <ModalFooterNDL>
                ...
                <Button type="primary"   danger={dangerValue} value={buttonValue} 
