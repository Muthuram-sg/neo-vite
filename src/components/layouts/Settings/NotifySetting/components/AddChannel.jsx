 ...
 const { t } = useTranslation();
    ...
    const handleUser = (event) => { 
      ...
      let Num = event.map(x=>{
        if(ChannelType === 'f85819bc-c2ca-45c8-a1a7-28320b7f44e6' || ChannelType === '5a58b377-18da-4852-8caa-33d0570eba94'){ // SMS
          return x.mobile 
        }else if(ChannelType === 'aee76d9f-843a-4041-badc-707d54ffcb3e' || ChannelType === '98d56817-cf8a-4163-8f19-152d47644607'){ // Email
          return x.email 
        }
  ...
  const clickUserButton = () => {
    ...
    if (userDialogMode === "delete") {
      getRemoveChannel(props.SelectRow.id, headPlant.id)
    }
      ...
      if (ChannelType === 'f85819bc-c2ca-45c8-a1a7-28320b7f44e6') { // SMS
        ...
        } else if (ChannelType === 'aee76d9f-843a-4041-badc-707d54ffcb3e') { // Email
        if(UserWise){
          if(ParamList.length === 0){
            setparamValid(true) 
            return false   
    ...
    let msg = '';
      ...
      let label = '';
        ...
        if (ChannelType === 'f85819bc-c2ca-45c8-a1a7-28320b7f44e6') {
          label = 'Phone Number*';
        } else if (ChannelType === 'aee76d9f-843a-4041-badc-707d54ffcb3e' || ChannelType === '640641c1-fd44-4756-9c55-81be5a75ed3f') {
          label = 'Email*';
        } else {
          label = 'URL';
        }
