...
export default function ExUserDropDown({inputref, noOfMatchingEmployees,validEmail,value,MailVal,options,optionarr,showManualEmailAdd}) {
    ...
    const [employeeData, setEmployeeDetails] = React.useState(options);
    ...
    return ( 
        ...
        {MatchingEmployees === 0 && MatchingEmployees !== null &&
            <div style={{display:'flex',alignItems: 'center'}}>
                <TypographyNDL variant="lable-01-s" color="secondary" value={t('noEmployeesAvailable')} />
