...
function FactorsTabsFunction(props){
    const [curTheme]=useRecoilState(themeMode)
    return(
        <div class={`"flex flex-row  w-full padding p-0 h-14  z-10 ${curTheme==='dark' ? 'bg-black' : 'bg-primary-bg'} "`}>
        <TabListItems>
...
export default React.memo(FactorsTabsFunction,isRender)