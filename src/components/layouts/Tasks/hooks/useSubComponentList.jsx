...
const useSubComponentList = () => { 
    ...
    const getSubComponentList = async (mainComponentId) => { 
        setLoading(true); 
        await configParam.RUN_GQL_API(gqlQueries.getSubComponentMaster,{mcc_id: mainComponentId}) 
    ...
    return { SubComponentListLoading, SubComponentListData, SubComponentListError, getSubComponentList }; 
}; 

export default useSubComponentList; 